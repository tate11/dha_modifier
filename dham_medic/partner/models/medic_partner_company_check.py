...
class PartnerCompanyCheck(models.Model):
    ...
    def action_show_medical_bill_done(self):
        action = self.env.ref('dham_medic.medic_medical_bill_action').read()[0]
    ...
    def parse_export_data(self):
        ...
        Noi = self.env.ref('dham_medic.khoa_nhi')
    ...
    def _compute_test_val(self, medical):
        ...
        res = ['', '', '', '']
        XN = self.env.ref('dham_medic.medic_test_type_lab_test')
        XQ = self.env.ref('dham_medic.medic_test_type_image_test')
        SA = self.env.ref('dham_medic.medic_test_type_echograph')
        DT = self.env.ref('dham_medic.medic_test_type_electrocardiogram')
    ...
    def _compute_text_val(self, type, medical):
        ...
        TypeID = self.env.ref('dham_medic.' + TypeID)
    ...
    def action_show_schedule(self):
        action = self.env.ref('dham_medic.action_company_contract_schedule').read()[0]
