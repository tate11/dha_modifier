...
class ResPartner(models.Model):
    ...
    customer_id = fields.Char('Customer ID', readonly=1, track_visibility='onchange')
    sex = fields.Selection([('male', 'Male'),('female','Female')], 'Sex', track_visibility='onchange')
    day_of_birth = fields.Date('Day of Birth', track_visibility='onchange')
    age = fields.Char('Ages', compute='_compute_age', track_visibility='onchange')
    ...
    def open_company_check_history(self):
        for record in self:
            ...
            action = self.env.ref('dham_medic.action_res_partner_company_check')
...
class ResCountry(models.Model):
    ...
    def import_template_country_data(self):
        ...
        module_path = get_module_path('dham_medic')
