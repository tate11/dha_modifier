...
*/
odoo.define('dham_medic.webcam_widget', function(require) {
    "use strict";
    ...
    core.form_widget_registry.get("image").include({
        ...
        render_value: function () {
            ...
            Webcam.set({
                ...
                force_flash: false,
                fps: 45,
                swfURL: '/dham_medic/static/src/js/webcam.swf',
            });

            self.$el.find('.oe_form_binary_file_clear').removeClass('col-md-offset-5');

            new Model('ir.config_parameter').call('get_param', ['dham_medic.flash_fallback_mode', false]).
            ...
            self.$el.find('.oe_form_binary_file_web_cam').off().on('click', function(){
                ...
                WebCamDialog.find("#webcam_result").html('<img src="/dham_medic/static/src/img/webcam_placeholder.png"/>');
            });
        },
    });
